        ...
        {facilitiesList.map((facility) => {
          ...
          return (
            <Reveal key={facility.key}>
              <div className="group flex flex-col items-center gap-3 rounded-2xl border border-[hsl(var(--border))] bg-[hsl(var(--card))] px-4 py-6 text-center transition-all duration-500 hover:-translate-y-1 hover:shadow-md">
                <span className="flex h-11 w-11 items-center justify-center rounded-xl bg-[hsl(var(--muted))] text-[hsl(var(--primary-strong))] transition-transform duration-500 group-hover:scale-110">
