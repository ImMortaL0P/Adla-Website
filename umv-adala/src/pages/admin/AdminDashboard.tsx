...
import { Image as ImageIcon, Users, FileText, Bell } from 'lucide-react';
...
export default function AdminDashboard() {
  const [activeTab, setActiveTab] = useState<'notices' | 'images' | 'staff' | 'content'>('notices');
  ...
  const tabs = [
    ...
    { id: 'content', label: 'Admission & Text Info', icon: FileText },
  ] as const;
